...
it('does not expose child points for an unapproved parent relation on the web route', function () {
    $parent = User::factory()->approved()->create();
    $child = User::factory()->approved()->create([
        'student_id' => 'PENDING-WEB-1001',
    ]);
    ...
    $response = actingAs($parent)->get(route('parent.children.index'));
