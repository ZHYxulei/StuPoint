...
export default function EditActivity({ activity }: PageProps) {
    const { data, setData, put, processing, errors } = useForm({
        title: activity.title,
        description: activity.description || '',
        start_date: activity.start_date.slice(0, 16),
        end_date: activity.end_date.slice(0, 16),
        location: activity.location,
        max_participants: activity.max_participants.toString(),
        points_reward: activity.points_reward.toString(),
        status: activity.status,
    });

    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        put(`/student-council/activities/${activity.id}`);
    };
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    <Card className="border-sidebar-border/70 dark:border-sidebar-border">
                        <CardHeader>
                            ...
                            <CardDescription>修改活动的基本信息</CardDescription>
                        </CardHeader>
                    ...
                    <Card className="border-sidebar-border/70 dark:border-sidebar-border">
                        <CardHeader>
                            ...
                            <CardDescription>修改参与人数和积分奖励</CardDescription>
                        </CardHeader>
                        <CardContent className="space-y-4">
                            <div className="grid gap-4 md:grid-cols-2">
                                <div className="space-y-2">
